...
[![GitHub stars](https://img.shields.io/github/stars/data-scrape/linkedin-scraper-api?style=social)](https://github.com/data-scrape/linkedin-scraper-api)
[![GitHub forks](https://img.shields.io/github/forks/data-scrape/linkedin-scraper-api?style=social)](https://github.com/data-scrape/linkedin-scraper-api/fork)
[![GitHub issues](https://img.shields.io/github/issues/data-scrape/linkedin-scraper-api)](https://github.com/data-scrape/linkedin-scraper-api/issues)
[![GitHub license](https://img.shields.io/github/license/data-scrape/linkedin-scraper-api)](https://github.com/data-scrape/linkedin-scraper-api/blob/main/LICENSE)
[![Python](https://img.shields.io/badge/Python-3.8+-blue?logo=python)](https://www.python.org/)

</div>


> LinkedIn scraper API - REST API for LinkedIn data extraction


<!-- SEO keywords: linkedin scraper api, Linkedin Scraper Api, linkedin scraper api python, linkedin scraper api github -->
...
- RESTful API for LinkedIn data extraction
- Endpoints for profiles, jobs, companies, posts
...
Build LinkedIn data services or integrate professional data into apps.
...
```bash
pip install git+https://github.com/data-scrape/linkedin-scraper-api.git
```

### From source

```bash
git clone https://github.com/data-scrape/linkedin-scraper-api.git
...
```python
from linkedin_scraper_api import Scraper
...
```bash
python linkedin_scraper_api.py --query "your-query" --output results.json
```
...
### Is Linkedin Scraper Api legal to use?
...
1. **⭐ Star this repository** — [Click here to star](https://github.com/data-scrape/linkedin-scraper-api)
2. **📧 Share with your network** — Help others discover this tool
3. **🐛 Report issues** — [Open an issue](https://github.com/data-scrape/linkedin-scraper-api/issues)
